...
nonisolated enum SummaryReportRenderer {
    ...
    private static func draw(_ snapshot: ProjectReportSnapshot, on page: ReportPage, includeCharts: Bool) {
        ...
        drawExpenses(snapshot, on: page, includeCharts: includeCharts)
    ...
    private static func drawExpenses(_ snapshot: ProjectReportSnapshot, on page: ReportPage, includeCharts: Bool) {
        if includeCharts {
